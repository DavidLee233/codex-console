...
def create_app() -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        async def run_account_token_maintenance_once() -> None:
            try:
                ...
                logger.warning("Account token maintenance failed: %s", exc)

        async def periodic_account_token_maintenance() -> None:
            ...
            while True:
                try:
                    ...
                    logger.warning("Periodic account token maintenance failed: %s", exc)
